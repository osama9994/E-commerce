        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (_, index) {
                        ...
                        return Card(
                          elevation: 0,
                          child: ListTile(
                            onTap: () => paymentMethodsCubit.changePaymentMethod(card.id),
                              ...
                              builder: (context, state) {
                                if (state is PaymentMethodChosen) {
                                  return Radio<String>(
                                    ...
                                    groupValue: state.chosenPayment.id,
                                    // ignore: deprecated_member_use
                                    onChanged: (id) {
              ...
              // إضافة بطاقة جديدة
              InkWell(
                onTap: () => Navigator.of(context).pushNamed("/addNewCardRoute"),
                child: Card(
                  elevation: 0,
                  child: ListTile(
                    leading: DecoratedBox(
              ...
              BlocConsumer<PaymentMethodsCubit, PaymentMethodsState>(
                ...
                listener: (context, state) {
                  if (state is ConfirmPaymentSuccess) Navigator.of(context).pop();
                },
                buildWhen: (previous, current) =>
                ...
                builder: (context, state) {
                  if (state is ConfirmPaymentLoading) {
                    return MainBotton(isLoading: true, onTap: null);
                  }
                  return MainBotton(
                    text: "Confirm Payment",
                    onTap: () => paymentMethodsCubit.confirmPaymentMethod(),
                  );
                },
              ),
            ],
